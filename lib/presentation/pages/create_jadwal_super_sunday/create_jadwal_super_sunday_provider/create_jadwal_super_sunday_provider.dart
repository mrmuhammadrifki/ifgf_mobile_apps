...
class CreateJadwalSuperSundayProvider extends ChangeNotifier {
  ...
  CreateJadwalSuperSundayProvider(
  ...
  Future<DataState<bool>> createJadwal({
    ...
    try {
      await _jadwalFirestoreService.createJadwalSuperSunday(
        dateTime: dateTime,
        location: location,
        petugas: petugas,
        thumbnail: thumbnail,
  ...
  Future<DataState<SuperSundayResponse?>> getOneAcara({String? id}) async {
    try {
